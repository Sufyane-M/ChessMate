...
export const setVariableScrollbarWidth = () => {
  let scroller = document.scrollingElement;

  // If scroller doesn't exist or not supported (IE11)
  ...
  requestAnimationFrame(() => {
    ...
    scroller.style.setProperty('--scrollbar-width', window.innerWidth - scroller.clientWidth);
